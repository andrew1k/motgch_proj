<template>
  ...
  />
  <v-card-actions>
    <VBtn icon="mdi-chevron-left" density="comfortable" color="fellowship" variant="text" @click="$emit('goBack')"/>
    <VSpacer />
    <v-btn variant="text" color="fellowship"  elevation="0">Присоединиться</v-btn>
  </v-card-actions>
</template>
